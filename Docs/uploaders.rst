...
As a standalone unit, MEGYCLOG is a very capable data logger
...
service. MEGYCLOG has the capability to upload selected data 
while still maintaining all of its own local logging 
and reporting capabilities.

When one of these services becomes unavailable for any reason,
MEGYCLOG will upload the backlog when service is restored,
whether that backlog is a minute or a month.

MEGYCLOG can support multiple upload services simultaneously,
