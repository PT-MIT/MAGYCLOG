...
Use the url: ``http://MEGYCLOG.local`` or, if your device
...
If you have more than one MEGYCLOG you will need to do this so that they
each have unique names. When you press save, the MEGYCLOG will restart using
...
MEGYCLOG has DST rules for most of North America, Europe, Australia and New Zealand.

Auto-update Class
----------------- 

Auto-update Class tells MEGYCLOG if you want to receive 
...
MEGYCLOG checks the MEGYCLOG.com site for new software regularly.
The update process takes less than a minute.
New firmware is authenticated with a digital signature from MEGYCLOG and installed automatically.
